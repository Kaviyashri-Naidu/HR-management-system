...
Public Class CustForm
    ...
    Sub SaveRecord()
        ...
        Conn.Open()
        Dim Cmd0 As New SqlCommand("select custCode from CustTab where custCode='" & UCase(TextBox1.Text) & "'", Conn)
    ...
    Sub disRecords()
        ...
        Dim adp As New SqlDataAdapter("Select custCode,CustName From CustTab order by custCode", Conn)
        adp.Fill(DS1)
